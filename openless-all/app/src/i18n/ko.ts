...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      macosNewlineModeDesc: '한 글자씩 입력할 때 줄바꿈을 보내는 방식입니다. 채팅 앱에서는 Shift+Return을, Terminal.app에서 Codex / Claude Code 같은 CLI 에이전트를 사용할 때는 Line Feed(U+000A / Ctrl+J)를 선택하세요. 일반 Return은 메시지를 전송합니다.',
