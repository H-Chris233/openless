...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    codingAgent: {
      title: '음성 Agent(빠른 Agent)',
      desc: '전역 단축키로 Claude Code(또는 OpenCode)를 바로 실행해 빠른 작업 수행. 기본 비활성, 여기서 설정.',
      enable: '음성 Agent 활성화',
      comingSoonNote: '설정은 즉시 저장됩니다. 단축키 트리거와 실행 흐름은 이후 버전에서 제공됩니다.',
      hotkeyHint: '두 단축키는 「일반 → 단축키」에서 설정.',
      provider: 'Agent 백엔드',
