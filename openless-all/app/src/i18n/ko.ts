...
export const ko: typeof zhCN = {
  ...
  history: {
    ...
    repolish: {
      title: '다시 다듬기',
      hint: '위 원문으로 다듬기를 다시 실행합니다. 결과는 이번 조회에만 표시되며 기록에 반영되지 않습니다.',
      retry: '같은 스타일로 재시도',
      retrying: '재시도 중…',
      apply: '적용',
      applying: '다듬는 중…',
  ...
  settings: {
    ...
    providers: {
      ...
      asrAdvancedNote: '아래 고급 옵션은「커스텀 OpenAI 호환」프리셋에만 적용됩니다. 명명된 공급자 프리셋은 내장 동작을 유지합니다.',
  ...
  localAsr: {
    ...
    modelSelectDesc: '다운로드된 모델 중 현재 인식 모델을 고릅니다. 추가는 아래 「다운로드 및 관리」에서.',
