...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    codingAgent: {
      title: 'Less Computer',
      desc: '전역 키를 누른 채 말하면 Claude가 계획이나 작은 작업을 한 번에 처리합니다. 현재는 macOS에서만 동작합니다.',
      ...
      voiceHotkeyDesc: '왼쪽/오른쪽 Control, 왼쪽/오른쪽 Option, Fn 또는 일반 조합 키를 지원합니다. 누르면 녹음, 놓으면 Claude로 보냅니다.',
      provider: 'Agent 백엔드',
