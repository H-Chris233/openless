...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      volcengineApiKeyNote: '使用火山方舟語音模型的 API Key 鑑權，無需 APP ID。Resource ID 預設使用 volc.seedasr.sauc.duration。',
  ...
  localAsr: {
    ...
    metalToolchainTitle: 'macOS MLX 首次建置需求',
    metalToolchainDesc: '如果首次執行開發版時提示缺少 MetalToolchain，請先安裝 Xcode 元件。',
    metalToolchainStep: '在終端機執行以下命令，完成後重新啟動 OpenLess：',
    metalToolchainCopy: '複製命令',
    metalToolchainCopied: '已複製',
    metalToolchainVerify: '可使用 xcrun --find metal 驗證安裝是否成功。',
    test: '加載並測試',
    testRunning: '測試中…',
    testHeading: '內置音頻測試',
    testExpected: '原文',
