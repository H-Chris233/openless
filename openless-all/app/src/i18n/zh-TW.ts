...
export const zhTW: typeof zhCN = {
    ...
    qa: {
        ...
        emptyDesc:
            "在任意 app 選中一段文字後，按一次 {{recordHotkey}} 開始錄音，再按一次結束並提交。回答會顯示在這裏，可以連續多輪追問。",
    ...
    marketplace: {
        ...
        myPacks: {
            ...
            emptyHint:
                "在「風格」頁面編輯後點「發布到風格市場」，或點擊右上角上傳本機風格包。",
            noMatch: "沒有符合的風格包",
        ...
        modal: {
            ...
            notLoggedIn:
                "未登入 —— 去 Settings → 錄音 → 風格市場 填一個發布者名",
    ...
    onboarding: {
        ...
        hotkeyTitle: "全局快捷鍵",
        accessibilityDesc:
            "用於監聽全局快捷鍵（默認 {{trigger}}）並把識別結果寫入光標位置。",
    ...
    vocab: {
        ...
        corrections: {
            ...
            empty: "還沒有糾正規則。",
            invalid:
                "僅支援字面替換，或一個 {num} 通配數字的規則，例如 {num}粒 → {num}例。",
            tipDisabled: "點擊停用此規則",
            tipEnabled: "點擊啟用此規則",
            removeAria: "刪除糾正規則",
        },
    ...
    style: {
        ...
        customPromptPlaceholder:
            "可選，追加到這個風格的內建 system prompt 末尾。",
        customPromptHint:
    ...
    selectionAsk: {
        ...
        howto: {
            ...
            privacyTitle: "隱私契約",
            privacyDesc:
                "選中文本僅存於記憶體，關閉浮窗即銷毀。超 4000 字元自動截斷。",
        },
    },
    settings: {
        kicker: "SETTINGS",
        ...
        recording: {
            ...
            hotkeyLabel: "錄音快捷鍵",
            hotkeyDescAcc:
                "按下即開始捕獲語音，全局生效。需要授予輔助功能權限。",
            hotkeyDescNoAcc:
                "按下即開始捕獲語音，全局生效。無需額外輔助功能授權。",
            modeLabel: "錄音方式",
            modeDesc:
            ...
            comboRecordDesc:
                "點擊後按下你想要的快捷鍵組合（如 ⌘⇧D），支援 Toggle 與 Hold 模式。",
            ...
            microphoneDialogDesc:
                "選擇能捕捉到您聲音的麥克風。如果指示條沒有移動，請嘗試其他麥克風。",
        ...
        providers: {
            ...
            volcengineMappingNote:
                "Secret Key 當前無需填寫。Resource ID 默認使用 volc.bigasr.sauc.duration。",
            localAsrActiveNotice:
                "當前已啓用「{{name}}」，可在「高級」中切換或停用。",
            localAsrTakeoverHint: "啓動「{{name}}」後，ASR 提供商將被接管。",
            asrProviderTakenOver: "ASR 提供商已被接管",
            localAsrHint:
                "在本機運行，無需 API Key。從 HuggingFace 下載模型即可使用。",
            foundryLocalAsrHint:
                "在本機運行，無需 ASR API Key。首次使用需下載運行元件和模型。",
            localAsrPerformanceWarning:
                "本地推理比雲端慢，中文準確率可能更低。適合離線或隱私敏感場景。",
            ...
            thinkingModeOff: "關閉",
            thinkingModeHint:
                "關閉時按渠道級官方參數關閉或降低思考；開啟時按渠道預設啟用思考。不注入 prompt，也不做單模型適配。",
            bailianVocabularyIdLabel: "熱詞 Vocabulary ID（可選）",
            bailianVocabularyIdNote:
                "如已在百煉建立熱詞表，可填寫 vocab-...；留空則不下發熱詞。",
            appIdLabel: "App ID（應用 ID）",
            accessKeyLabel: "Access Key",
            resourceIdLabel: "資源 ID",
            toolsLabel: "連接檢查",
            toolsDesc:
                "先保存上方配置，再驗證當前模型連通性或拉取模型；失敗時仍可手動填寫模型 ID。",
            validate: "驗證",
            validating: "驗證中…",
            fetchModels: "拉取模型",
            loadingModels: "拉取模型中…",
            ...
            endpointMustUseHttps:
                "Endpoint 必須使用 HTTPS（本地 localhost/127.0.0.1 測試除外）。",
        ...
        permissions: {
            title: "權限",
            descAcc:
                "OpenLess 需要以下系統權限才能正常工作。授權後通常需要完全退出 App 重啓一次才生效。",
            descNoAcc:
        ...
        about: {
            ...
            betaChannelDesc:
                "開啟後自動接收 Beta 版本。可能不穩定，僅推薦願意嘗鮮的用戶。",
    ...
    modal: {
        ...
        account: {
            ...
            loginSync: "登錄 / 同步",
            footer: "預設完全本地運行。登入後可跨裝置同步詞彙表與風格預設。",
        },
        personalize: {
            appearance: "外觀",
            ...
            blur: "毛玻璃強度",
            blurDesc:
                "影響窗口內層 backdrop-filter 強度（macOS 系統磨砂層無法運行時調）。",
            startupOpen: "啓動時打開",
            startupOverview: "概覽",
            startupLast: "上次位置",
            startupAtBoot: "開機自啓",
    ...
    localAsr: {
        ...
        qwenUnavailableOnWindows:
            "Windows 暫不支援 Qwen3-ASR，請使用上方的 Foundry Local Whisper。",
        foundryTitle: "Windows Foundry Local Whisper",
        foundryDesc:
            "在本機識別語音，無需 ASR API Key。首次使用需下載運行元件和模型。",
        ...
        sherpaDesc:
            "Windows 使用 sherpa-onnx 在本機離線批量識別，無需 ASR API Key。",
        sherpaRuntimeReady: "模型已加載",
        sherpaRuntimeMissing: "模型未加載",
        sherpaSetDefault: "設為默認 / 啟用 sherpa-onnx",
        sherpaPrepare: "檢查本地文件 / 加載",
        sherpaPreparing: "加載中…",
        sherpaPrepareLocalFiles: "檢查本地模型文件",
        sherpaModelDir: "模型目錄",
        sherpaRevealDir: "打開模型目錄",
        sherpaError: "sherpa-onnx 狀態",
        sherpaLanguageJa: "日語 ja",
        sherpaLanguageKo: "韓語 ko",
        sherpaLanguageYue: "粵語 yue",
        sherpaModelSenseVoice: "SenseVoice Small（默認 / 中文優先）",
        sherpaModelSenseVoiceDesc: "默認實驗模型，適合中文與中英混合聽寫。",
        ...
        sherpaModelQwen3Desc:
            "轉換後的 sherpa-onnx Qwen3-ASR 模型，支持多語言識別與更強的長上下文能力。",
        mirrorLabel: "下載鏡像源",
        mirrorDesc:
            "官方源在國外網絡更穩；hf-mirror.com 是國內社區維護的鏡像。",
        mirrorHuggingface: "HuggingFace 官方 (huggingface.co)",
        mirrorHfMirror: "國內鏡像 (hf-mirror.com)",
        mirrorGithubRelease: "GitHub Release 歸檔",
        activeBadge: "當前使用",
        downloadedBadge: "已下載",
        ...
        testActual: "識別",
        testStats:
            "音頻時長 {{audio}}s · 加載 {{load}}s · 推理 {{transcribe}}s · 後端 {{backend}}",
        testFailed: "測試失敗",
        ...
        keepLoadedDesc:
            "決定 Qwen3-ASR 用完後多久從內存釋放，避免長期佔用內存。",
