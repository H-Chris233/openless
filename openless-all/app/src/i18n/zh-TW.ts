...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackDesc: 'Windows：TSF 失敗後允許繼續用剪貼簿貼上或 Unicode SendInput 兜底。',
      windowsNonTsfFallbackModeLabel: '非 TSF 兜底方式',
      windowsNonTsfFallbackModeDesc: '默認用剪貼簿貼上，避免長文本卡頓；如果目標應用會吞貼上快捷鍵，可改用 Unicode SendInput。',
      windowsNonTsfFallbackModeClipboardPaste: '剪貼簿 + 貼上快捷鍵（默認）',
      windowsNonTsfFallbackModeUnicodeKeystrokes: 'Unicode SendInput（兼容吞貼上的應用）',
      ...
      autoUpdateCheckDesc: '主視窗啟動時 + 後台每 60 分鐘檢查雲端新版本。關閉後僅「關於」的手動按鈕可用。',
