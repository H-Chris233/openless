...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    remoteInput: {
      ...
      certHint: "首次連線需核對根憑證指紋後再信任。升級舊版需設定一次；之後重新啟動和更換 IP 會保留信任。",
      ...
      certVerifyHint: "在手機系統的憑證詳細資訊中找到 SHA-256，與此處全部 64 個字元逐一核對（忽略空格和冒號）。必須在開啟完全信任前完成。網頁、描述檔名稱與識別碼不能證明憑證身分；若不一致或無法查看完整指紋，請停止並移除已下載或安裝的描述檔。",
