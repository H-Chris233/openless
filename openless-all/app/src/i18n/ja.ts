...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      macosNewlineModeDesc: '逐次入力時に改行をどう送るか。チャットでは Shift+Return、Terminal.app で Codex / Claude Code などの CLI エージェントを使う場合は Line Feed（U+000A / Ctrl+J）。通常の Return は送信になります。',
