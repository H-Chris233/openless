...
export const ja: typeof zhCN = {
  ...
  history: {
    ...
    repolish: {
      title: '再整文',
      hint: '上の原文でもう一度整文を実行します。結果は今回の表示のみで、この記録には書き戻しません。',
      retry: '同じスタイルで再試行',
      retrying: '再試行中…',
      apply: '適用',
      applying: '整文中…',
  ...
  settings: {
    ...
    providers: {
      ...
      asrAdvancedNote: '以下の詳細オプションは「カスタム OpenAI 互換」プリセットのみに影響します。名前付きプロバイダーのプリセットは内蔵動作のままです。',
  ...
  localAsr: {
    ...
    modelSelectTitle: 'モデル選択',
    modelSelectDesc: 'ダウンロード済みモデルから現在の認識モデルを選びます。追加は下の「ダウンロードと管理」から。',
