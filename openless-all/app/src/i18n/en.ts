...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      allowNonTsfFallbackDesc: 'Windows: when TSF insertion fails, allow clipboard paste or Unicode SendInput as a fallback.',
      windowsNonTsfFallbackModeLabel: 'Non-TSF fallback method',
      windowsNonTsfFallbackModeDesc: 'Default to clipboard paste to avoid long-text stalls; switch to Unicode SendInput for apps that swallow paste shortcuts.',
      windowsNonTsfFallbackModeClipboardPaste: 'Clipboard + paste shortcut (default)',
      windowsNonTsfFallbackModeUnicodeKeystrokes: 'Unicode SendInput (for paste-blocking apps)',
      ...
      autoUpdateCheckDesc: 'Check for new releases on main window launch and every 60 minutes. When off, only the manual "Check for updates" button in About works.',
      ...
      marketplaceDevLoginDesc: 'Dev-mode identifies uploader by GitHub login. When blank, upload/like is disabled. Will be replaced by OAuth later.',
