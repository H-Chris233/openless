...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      asrAdvancedNote: 'Advanced options below only affect the Custom OpenAI-compatible preset; named provider presets keep their built-in behavior.',
  ...
  localAsr: {
    ...
    modelSelectDesc: 'Pick one of your downloaded models as the active recognizer; get more in “Download & manage” below.',
