...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    codingAgent: {
      title: 'Less Computer',
      desc: 'Hold a global key, speak, and let Claude complete a plan or small task in one shot. macOS only for now.',
      ...
      voiceHotkeyDesc: 'Supports left/right Control, left/right Option, Fn, or a normal combo. Hold to record; release to send to Claude.',
