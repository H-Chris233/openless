...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    codingAgent: {
      title: 'Voice Coding Agent',
      desc: 'Trigger Claude Code (or OpenCode) by a global hotkey to run quick tasks. Off by default; configure it here.',
      enable: 'Enable Voice Coding Agent',
      comingSoonNote: 'Config is saved now; hotkey triggering and the execution flow land in a later version.',
      hotkeyHint: 'Set the two hotkeys under General → Shortcuts.',
    ...
    shortcuts: {
      ...
      agentPolish: 'Polish selection (Claude)',
