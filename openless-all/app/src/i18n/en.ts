...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      macosNewlineModeDesc: 'How line breaks are sent while typing out text. Use Shift+Return for chat apps; use Line Feed (U+000A / Ctrl+J) for CLI agents such as Codex or Claude Code in Terminal.app. Plain Return sends the message.',
