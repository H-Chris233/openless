...
export const en: typeof zhCN = {
    ...
    qa: {
        ...
        emptyDesc:
            "Select text in any app, press {{recordHotkey}} once to start recording, press it again to submit. Answers appear here. You can ask follow-up questions in the same panel.",
    ...
    marketplace: {
        ...
        uploadBtn: "Upload",
        uploadDisabledHint:
            "Set your GitHub login in Settings → Marketplace first",
        refreshBtn: "Refresh",
        ...
        uploadHint:
            "Uploading as {{login}}. Content goes to the cloud review queue.",
        ...
        detail: {
            ...
            withdrawConfirm:
                'Withdraw "{{name}}" from the marketplace? Your local copy is kept.',
        ...
        oauth: {
            ...
            reloginTooltip:
                "Click to re-sign-in / switch account (current @{{login}})",
        },
        modal: {
            loggedIn:
                "Current sign-in identity — change in Settings → Recording → Marketplace",
            notLoggedIn:
                "Not signed in — go to Settings → Recording → Marketplace to set publisher name",
    ...
    onboarding: {
        ...
        hotkeyDesc:
            "Used to confirm that the global hotkey listener is available.",
        micTitle: "Microphone",
    ...
    overview: {
        ...
        recentAll: "View all →",
        recentEmpty:
            "No records yet. Press {{trigger}} to start your first recording.",
    ...
    history: {
        ...
        confirmClear:
            "Delete all {{count}} history entries? This cannot be undone.",
    },
    vocab: {
        kicker: "VOCABULARY",
        title: "Vocabulary",
    ...
    style: {
        ...
        customPromptPlaceholder:
            "Optional. Appended to this style’s built-in system prompt.",
        customPromptHint:
        ...
        modes: {
            raw: {
                ...
                sample: "Keeps spoken cadence; fillers like 'um' or 'you know' get dropped, but sentences stay intact.",
            },
            light: {
                name: "Light polish",
                desc: "Drops fillers, adds punctuation, and produces sendable natural prose.",
                sample: "Makes the transcript flow well without sounding scripted — your tone and habits remain.",
            },
            structured: {
                name: "Structured",
    ...
    translation: {
        ...
        save: {
            workingFailed:
                "Failed to save working languages. Please try again.",
            targetFailed:
                "Failed to save translation target. Please try again.",
            hotkeyRegisterFailed:
                "Failed to register the translation shortcut. The preference was not saved.",
            hotkeySaveFailed:
                "Failed to save the translation shortcut. Please try again.",
        },
        howto: {
            title: "How to use",
    ...
    selectionAsk: {
        ...
        save: {
            hotkeyRegisterFailed:
                "Failed to register the Selection Ask shortcut. The preference was not saved.",
            hotkeySaveFailed:
                "Failed to save the Selection Ask shortcut. Please try again.",
            historySaveFailed:
                "Failed to save the Q&A history setting. Please try again.",
        },
        history: {
            title: "Save history",
        ...
        howto: {
            ...
            windowDesc:
                "The panel is draggable and remembers its position. Pin to keep it open.",
            privacyTitle: "Privacy contract",
            privacyDesc:
                "Selected text lives only in memory until the panel closes. Text over 4000 chars is truncated.",
        },
    },
    settings: {
        kicker: "SETTINGS",
        ...
        recording: {
            ...
            hotkeyDescAcc:
                "Press to capture voice globally (requires Accessibility permission).",
            ...
            microphoneDialogDesc:
                "Choose a microphone that can pick up your voice.",
            microphoneMonitorError:
                "Failed to monitor input level: {{message}}",
            ...
            historyMaxEntriesDesc:
                "Max sessions retained locally. Blank = 200. Range 5–200.",
            ...
            startMinimizedDesc:
                "No main window on any launch path — menu bar / tray only.",
            ...
            marketplaceBaseUrlDesc:
                "Marketplace backend URL. Blank uses the default.",
            marketplaceDevLoginLabel: "GitHub login (upload identity)",
            marketplaceDevLoginDesc:
                "Identifies the uploader. Blank disables upload and likes.",
        ...
        providers: {
            ...
            llmProviderDesc:
                "Selecting a preset auto-fills the default Base URL.",
            ...
            asrProviderDesc:
                "Switching providers automatically loads the matching credentials.",
            ...
            volcengineMappingNote:
                "Secret Key is not required right now. Resource ID defaults to volc.bigasr.sauc.duration.",
            localAsrActiveNotice:
                "Local ASR ({{name}}) is currently active. Switch or disable it from the Advanced tab.",
            localAsrTakeoverHint:
                'Once "{{name}}" is enabled, the ASR provider will be taken over.',
            asrProviderTakenOver: "ASR provider taken over",
            localAsrHint:
                "Runs on this machine, no API key needed. Download the model from HuggingFace.",
            foundryLocalAsrHint:
            ...
            modelMissing:
                "No model is configured. Please enter a model ID first.",
            ...
            endpointMustUseHttps:
                "Endpoint must use HTTPS (localhost/127.0.0.1 are allowed for local testing).",
            endpointInvalid: "Endpoint format is invalid.",
            responseTooLarge:
                "Provider response is too large to validate safely.",
        ...
        permissions: {
            ...
            accDesc:
                "Used to listen to the global hotkey and write transcripts at the cursor.",
            hotkeyLabel: "Global hotkey",
            hotkeyDescWithAdapter:
                "Active adapter: {{adapter}}. Used to confirm the hotkey listener is installed.",
            hotkeyDescPlain:
                "Used to confirm the hotkey listener is installed.",
            networkLabel: "Network",
            networkDesc:
                "Required for cloud ASR / LLM calls. Disable for local-only mode.",
            networkOk: "Available",
            checking: "Checking…",
            granted: "Granted",
            ...
            windowsIme: {
                installed:
                    "Installed. Voice input temporarily switches to the OpenLess IME.",
                notInstalled:
                    "Not installed. OpenLess is using the clipboard/WM_PASTE fallback.",
                registrationBroken:
                    "Registration is broken. Reinstall the OpenLess IME.",
        ...
        advanced: {
            ...
            localAsrWarningShort:
                "Local inference is slower; under-spec hardware may drop words.",
            ...
            notSupportedHere:
                "Not supported on this platform — no inference module bundled.",
            enable: "Enable",
            alreadyActive: "Active",
            disableLocalLabel: "Disable local ASR",
            disableLocalDesc:
                "Switch back to cloud ASR (defaults to Volcengine bigasr).",
            disable: "Disable",
        ...
        about: {
            ...
            updateError:
                "Update check or install failed. Please try again later.",
            ...
            privacy: "Privacy",
            privacyDesc:
                "All data stays on this device. Cloud APIs do not retain recordings.",
            localFirst: "Local-first",
            betaChannelLabel: "Join Beta channel",
            betaChannelDesc:
                "Receive Beta updates when enabled. May be unstable — recommended only for early adopters.",
            ...
            betaChannelFetchError:
                "Failed to fetch Beta release info. Please try again later.",
            betaChannelUpToDate: "Up to date",
            betaChannelUpdateNow: "Update now",
            betaChannelUpdateNowTitle:
                "Check and download the latest Beta, then show the update dialog",
    ...
    modal: {
        ...
        account: {
            ...
            footer: "Runs fully locally by default. Sign in to sync vocabulary and style presets across devices.",
        },
        personalize: {
        ...
        about: {
            ...
            privacy: "Privacy",
            privacyDesc:
                "All transcripts stay on this device. Cloud APIs are used only for real-time calls.",
            localFirst: "Local-first",
        },
    },
    windowChrome: {
    ...
    localAsr: {
        ...
        foundryRuntimeSourceDesc:
            "Runtime components are downloaded before first use.",
        ...
        foundryPrepareModelSkipped:
            "Model already downloaded; download skipped",
        ...
        foundryLanguageDesc:
            "Choose Chinese for Chinese dictation, Auto for mixed use.",
        foundryModelSmall: "Whisper Small (default / balanced)",
        foundryModelSmallDesc:
            "Default balanced option for quality and resource use.",
        ...
        foundryModelLargeDesc:
            "Large-model option for high-end devices and quality-first use.",
        foundryModelBase: "Whisper Base (faster / lower resource)",
        foundryModelBaseDesc:
            "Faster with lower resource use for lightweight daily dictation.",
        foundryModelTiny: "Whisper Tiny (fastest / smoke test)",
        foundryModelTinyDesc:
            "Fastest check option for confirming the Foundry path works.",
        ...
        mirrorGithubRelease: "GitHub release archive",
        activeBadge: "In use",
        ...
        keepLoadedDesc:
            "How long Qwen3-ASR stays in memory after the last use, before being freed.",
