...
export const zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      pasteShortcutDesc: '仅 Windows / Linux：插入文本时模拟按下的粘贴键。kitty / alacritty / wezterm / gnome-terminal 等终端只接受 Ctrl+Shift+V；xterm / urxvt 用 Shift+Insert。改完下一次听写即生效。详见 issue #360。',
