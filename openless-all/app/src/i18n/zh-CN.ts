...
export const zhCN = {
  ...
  settings: {
    ...
    remoteInput: {
      ...
      certHint: "首次连接需核对根证书指纹后再信任。升级旧版需设置一次；以后重启和换 IP 会保留信任。",
      ...
      certVerifyHint: "在手机系统的证书详情中找到 SHA-256，与这里的全部 64 个字符逐一核对（忽略空格和冒号）。必须在开启完全信任前完成。网页、描述文件名称和标识不能证明证书身份；若不一致或无法查看完整指纹，请停止并移除已下载或安装的描述文件。",
