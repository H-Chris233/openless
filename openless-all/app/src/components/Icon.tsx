...
export const ICONS: Record<string, string> = {
  // overview — 仪表盘式分屏布局（顶部摘要条 + 左右两块小卡），传达"概览/总览"
  overview: 'M4 5h16v5H4zM4 13h7v6H4zM13 13h7v6h-7z',
  ...
  // selectionAsk — 三行文本（"被选中的内容"）+ 右下角对话气泡（"追问"），直白表达"对选中文字提问"
  selectionAsk:'M3 5h12M3 9h12M3 13h7M14 14h6a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-3l-3 3v-3a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2z',
