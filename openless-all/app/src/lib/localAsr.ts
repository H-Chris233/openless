...
export type LocalAsrDownloadPhase = 'started' | 'progress' | 'finished' | 'cancelled' | 'failed';
...
export type FoundryPreparePhase = 'runtime' | 'model' | 'load' | 'finished' | 'failed';
...
export function setLocalAsrModelsBaseDir(
  ...
  return invokeOrMock('local_asr_set_models_base_dir', { modelsBaseDir }, () => ({
    modelsBaseDir,
    modelsRootDir: modelsBaseDir ? `${modelsBaseDir}/OpenLess/models` : MOCK_SETTINGS.modelsRootDir,
...
export function fetchLocalAsrRemoteInfo(
  ...
  return invokeOrMock('local_asr_fetch_remote_info', { modelId, mirror }, () => ({
    modelId,
...
export function fetchLocalAsrHfCard(modelId: string, mirror?: string): Promise<HfModelCard> {
  return invokeOrMock('local_asr_fetch_hf_card', { modelId, mirror }, () => ({
    modelId,
    mirror: mirror ?? 'huggingface',
    downloads: 0,
    likes: 0,
...
export function downloadLocalAsrModel(modelId: string, mirror?: string): Promise<void> {
...
export function revealLocalAsrModelDir(modelId: string): Promise<void> {
  return invokeOrMock('local_asr_reveal_model_dir', { modelId }, () => undefined);
}

export function revealLocalAsrModelsRoot(): Promise<void> {
  return invokeOrMock('local_asr_reveal_models_root', undefined, () => undefined);
}
...
export function setFoundryLocalAsrLanguageHint(languageHint: string): Promise<void> {
  return invokeOrMock('foundry_local_asr_set_language_hint', { languageHint }, () => undefined);
}
...
export function getFoundryLocalAsrModelDir(modelAlias: string): Promise<string> {
  return invokeOrMock('foundry_local_asr_model_dir', { modelAlias }, () => '');
}

export function deleteFoundryLocalAsrModel(modelAlias: string): Promise<void> {
  return invokeOrMock('foundry_local_asr_delete_model', { modelAlias }, () => undefined);
}

export function revealFoundryLocalAsrModelDir(modelAlias: string): Promise<void> {
  return invokeOrMock('foundry_local_asr_reveal_model_dir', { modelAlias }, () => undefined);
}
...
export function setSherpaOnnxAsrModel(modelAlias: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_set_model', { modelAlias }, () => undefined);
}

export function setSherpaOnnxAsrLanguageHint(languageHint: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_set_language_hint', { languageHint }, () => undefined);
}

export function prepareSherpaOnnxAsr(modelAlias: string): Promise<string> {
  return invokeOrMock('sherpa_onnx_asr_prepare', { modelAlias }, () => `mock-${modelAlias}`);
}

export function cancelSherpaOnnxAsrPrepare(): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_cancel_prepare', undefined, () => undefined);
}
...
export function revealSherpaOnnxAsrModelDir(modelAlias: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_reveal_model_dir', { modelAlias }, () => undefined);
}

export function deleteSherpaOnnxAsrModel(modelAlias: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_delete_model', { modelAlias }, () => undefined);
}
...
export function fetchSherpaOnnxAsrRemoteInfo(
  ...
  return invokeOrMock('sherpa_onnx_asr_fetch_remote_info', { modelAlias, mirror }, () => ({
    modelAlias,
    mirror: mirror ?? 'huggingface',
    files: [],
    totalBytes: 0,
...
export function downloadSherpaOnnxAsrModel(modelAlias: string, mirror?: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_download_model', { modelAlias, mirror }, () => undefined);
}

export function cancelSherpaOnnxAsrDownload(modelAlias: string): Promise<void> {
  return invokeOrMock('sherpa_onnx_asr_cancel_download', { modelAlias }, () => undefined);
}

export type SherpaOnnxLanguageHint = '' | 'auto' | 'zh' | 'en' | 'ja' | 'ko' | 'yue';

export type SherpaPreparePhase = 'runtime' | 'model' | 'load' | 'finished' | 'failed';
